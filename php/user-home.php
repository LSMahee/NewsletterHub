...
// Get user's subscriptions using your existing query
...
$subStmt->bind_param("s", $_SESSION['Email']);
$subStmt->execute();
...
// Set subscription flags based on the query results
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content" id="userDropdown">
                        ...
                        <a href="../feedback.html"><i class="fas fa-star"></i> Send Feedback</a>
                        <a href="apply.php"><i class="fas fa-star"></i> Apply to become a Writer!</a>
